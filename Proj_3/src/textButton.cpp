...
textButton::textButton(String str)
{
...
textButton::textButton(String str,int fSize,int posX, int posY)
{
...
void textButton::Init(String str,int fSize,int posX, int posY)
{
...
bool textButton::isHover(sf::Vector2i mousePos){
